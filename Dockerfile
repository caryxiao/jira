...
&& curl -o ${JIRA_INSTALL}/lib/postgresql-${PG_DRIVER_VERSION}.jar https://repo1.maven.org/maven2/org/postgresql/postgresql/${PG_DRIVER_VERSION}/postgresql-${PG_DRIVER_VERSION}.jar -L \
